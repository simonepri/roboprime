 ...
 * Derivative of the Arduino Servo Library created by Michael Margolis.
 * 
 * ****************************************************************************
 *
...
/* 
 * All the implementation is done in *.cpp files to get better
 * compatibility with avr-gcc without the Arduino IDE.
 */
